<div class="page-header">
    ...
    <div class="page-header-actions">
        <a class="btn btn-outline-success btn-sm" href="<?= e(base_url('reports/export?from=' . urlencode($from) . '&to=' . urlencode($to))) ?>">⬇ Export CSV</a>
    </div>
</div>
    ...
    <div class="card-body">
        <form class="row g-3 align-items-end" method="GET" action="<?= e(base_url('reports')) ?>">
            ...
            <div class="col-md-6 d-flex gap-2 align-items-end">
                ...
                <a class="btn btn-outline-secondary" href="<?= e(base_url('reports')) ?>">Reset</a>
                <a class="btn btn-outline-success" href="<?= e(base_url('reports/export?from=' . urlencode($from) . '&to=' . urlencode($to))) ?>">⬇ Export CSV</a>
            </div>
        </form>
    </div>
</div>
