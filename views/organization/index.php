<div class="page-header">
    <div class="page-header-left">
        <h1 class="page-header-title">Organization Info</h1>
        <p class="page-header-desc">Update organization details, branding assets, tax settings, and stock alert defaults used across the system.</p>
    </div>
</div>

<div class="card">
    <div class="card-header">
        <span><i class="fas fa-building"></i> Organization Details</span>
    </div>
    <div class="card-body">
        <form method="POST" action="<?= e(base_url('organization')) ?>" enctype="multipart/form-data" class="row g-4">
            <?= csrf_field() ?>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input
                            ...
                            placeholder="12.00"
                        >
                        <div class="form-hint">Used in POS totals, receipts, and daily sales reports.</div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <input
                            ...
                            placeholder="5"
                        >
                        <div class="form-hint">Products at or below this quantity trigger low stock alerts.</div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Replace Header/Banner</label>
            ...
            <div class="col-12">
                <div class="card-soft">
                    <div class="section-title">Current Brand Assets</div>
            ...
            <div class="col-12 d-flex justify-content-end">
                <button class="btn btn-primary" type="submit">
                    <i class="fas fa-save"></i> Save Organization Info
                </button>
            </div>
        </form>
    </div>
