<?php $action = "products/update"; $buttonText = "Update Product"; ?>
...
<div class="card">
    <div class="card-header">✏️ Edit Product Details</div>
    <div class="card-body">
                ...
                <div class="col-lg-8">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" name="description" rows="4"><?= e($product['description'] ?? (string) old('description')) ?></textarea>
                        </div>
                    </div>
                </div>
